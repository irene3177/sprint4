...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	// ваш код здесь
	avgRunningSpeed := meanSpeed(action, duration)

	return ((runningCaloriesMeanSpeedMultiplier * avgRunningSpeed *
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	// ваш код здесь
	avgWalkingSpeed := meanSpeed(action, duration)
	speedInMSec := avgWalkingSpeed * kmhInMsec
	height = height / cmInM
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	// ваш код здесь
	avgSwimmingSpeed := swimmingMeanSpeed(lengthPool, countPool, duration)

	return ((avgSwimmingSpeed + swimmingCaloriesMeanSpeedShift) *
